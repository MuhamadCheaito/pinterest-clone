    ...
    return (
        ...
        <div className='flex xl-flex-row flex-col m-auto bg-white' style={{maxWidth:'1500px', borderRadius: '32px'}}>
            ...
            className='flex justify-center items-center md:items-start flex-initial'>
                ...
                style={{maxHeight:'600px', borderRadius: '32px'}}
                alt='user-post'/>
            </div>
            <div className='w-full p-5 flex-1 xl:min-w-62'>
                <div className='flex items-center justify-between'>
                    ...
                    <a href={pinDetail.destination} target="_blank" rel="noreferrer">
                        {pinDetail.destination.length > 35 ? `${pinDetail.destination.slice(0,35)}...` : pinDetail.destination}
                    </a>
                </div>
                <div>
               ...
               <img className='w-8 h-8 rounded-full object-hover' src={pinDetail.postedBy?.image} alt="user-profile" />
    ...
    {pins?.length > 0 ? (
        <>
           ...
           loading ? (
                ...
                <p className='text-center text-red-500 text-2x mt-8 mb-4'>No more pins like this!</p>
                </>
            )
